...
<%--<meta http-equiv="refresh" content="1; URL=http://by-dbox.bayer-ag.com/Cockpit.aspx?VIEW=2&DETAILS=1" />
--%>
<title>G|Box -  DRS Contact Persons</title>
<link href="/_styles/subbox.css" rel="stylesheet" type="text/css" />
</head>

<body>

<form id="form1" runat="server"><img src="../Images/gbox-wl_logo.jpg" alt="G|Box - Bridging your Master Data" width="616" height="82" border="0" /></div>
<div class="mc-subweb-bdy">
<h1>Welcome to GBox.</h1>
<h1>You will be forwarded to DRS Contact Persons immediately!</h1>
